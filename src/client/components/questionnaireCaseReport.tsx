...
export default class QuestionnaireCaseReport extends Component<
  QuestionnaireCaseReportProps,
  QuestionnaireCaseReportState
> {
  ...
  render(): ReactElement {
    if (!this.state.loaded) {
      return (
        <tr>
          <td>
            <LoadingPanel message={"Getting cases"} />
          </td>
        </tr>
      );
    }
    ...
    return (
      <tr
        ...
        key={this.props.questionnaireName}
        data-testid={"questionnaire-table-row"}
      >
        <td
          className="ons-table__cell"
          data-testid={`questionnaire-case-report-questionnaire-${this.props.questionnaireName}`}
        >
          {this.props.questionnaireName}
        </td>
        <td
          className="ons-table__cell"
          data-testid={`questionnaire-case-report-total-${this.props.questionnaireName}`}
        >
          {this.props.caseCompletionReport.Total}
        </td>
        <td
          className="ons-table__cell"
          data-testid={`questionnaire-case-report-complete-${this.props.questionnaireName}`}
        >
          {this.props.caseCompletionReport.Complete} (
          {this.props.caseCompletionReport.CompletePercentage}%)
        </td>
        <td
          className="ons-table__cell"
          data-testid={`questionnaire-case-report-complete-percentage-${this.props.questionnaireName}`}
        >
          <progress
            id="file"
