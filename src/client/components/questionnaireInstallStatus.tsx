...
export default class QuestionnaireInstallStatusPanel extends Component<Record<string, never>, QuestionnaireInstallStatusState> {
    ...
    renderRows(): ReactElement[] {
        return this.state.installStatuses.map((status) => {
            const statusText = status.activeOnAllNodes ? "Active" : "Not active on all nodes";
