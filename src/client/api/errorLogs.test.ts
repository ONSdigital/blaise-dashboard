...
describe("Error Logs API", () => {
    ...
    it("returns logs list", async () => {
        ...
        mockAdapter.onGet("/api/logs/errors", { params: { scope: "non-blaise" } }).reply(200, logs);
    ...
    it("supports Blaise-only scope", async () => {
        ...
        mockAdapter.onGet("/api/logs/errors", { params: { scope: "blaise" } }).reply(200, logs);
    ...
    it("supports NISRA scope", async () => {
        ...
        mockAdapter.onGet("/api/logs/errors", { params: { scope: "nisra" } }).reply(200, logs);
    ...
    it("supports BTS scope", async () => {
        ...
        mockAdapter.onGet("/api/logs/errors", { params: { scope: "bts" } }).reply(200, logs);
    ...
    it("supports REST API scope", async () => {
        ...
        mockAdapter.onGet("/api/logs/errors", { params: { scope: "restapi" } }).reply(200, logs);
